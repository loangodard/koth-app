...
exports.manageSockets = (io) => {
    ...
    io.on("connection", socket => {
        ...
        socket.on('join_end_game', (data,cb) => {
            ...
            console.log(rooms_end_game.findIndex(e => {console.log(e);e.lobby == data.room}))
            console.log(rooms_end_game.find(e => e.lobby == data.room))
            console.log('------')
